...
const Page2 = () => {
  ...
  /*
    ...
    useEffect(() => {
      ...
      const imagePath = Array.from({ length: 134 }, (_, idx) => `/src/assets/astro/${idx}.png`);
  
      const loadImages = async () => {
        const loadedImages = await Promise.all(imagePath.map(path => new Promise(resolve => {
          const img = new Image();
          img.src = path;
    ...
    useEffect(() => {
      ...
      const animate = (timestamp) => {
        if (images.length > 0 && timestamp - lastFrame >= 1000 / 30) {
    ...
    <>
      <div className='bg-white'>
        <div id='section-2' className='  p-20 text-center'>
          ...
          <h1 className='rotateText1 font-[anzo4] text-[40vw] text-center leading-[35vw] '>IMPACTFUL</h1>
          <h1 className='rotateText2 font-[anzo4] text-[40vw] text-center leading-[35vw] '>DESIGN</h1>
          <h1 className='rotateText3 font-[anzo4] text-[40vw] text-center leading-[35vw] '>IS THE</h1>
          <h1 className='rotateText4 font-[anzo4] text-[40vw] text-center leading-[35vw] '>DESIGN</h1>
          <h1 className='rotateText5 font-[anzo4] text-[40vw] text-center leading-[35vw] '>THAT</h1>
          <div className='rotateText6 relative'>
            {/* <canvas ref={canvasRef} className='h-[90%] w-[80%] left-1/2 -translate-x-1/2 absolute bg-red-500'></canvas> */}
            <h1 className=' font-[anzo4] text-[40vw] text-center leading-[35vw]'>WORKS</h1>
          </div>
        </div>
        <div className=' flex justify-center  '>
          <svg preserveAspectRatio="xMidYMid meet" data-bbox="4 0 2028.339 83" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2037 91" height="91" width="903" data-type="ugc" role="img" aria-label="Tesla, Figma, Wix Studio, Google+, BeHance monochrome Logo Design by Anzo Studio ">
            <g>
        ...
        <div className='mb-10 w-1/3  relative left-1/2 -translate-x-1/2 h-1 border-2 border-b-2 border-black bg-black'></div>
      </div>
    </>
  )
}
